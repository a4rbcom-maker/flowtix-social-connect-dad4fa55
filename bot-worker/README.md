...
1. الـ Worker يعمل polling كل 3 ثواني على `/api/public/bot/next-job`
2. لو مفيش مهام، الفاصل يزيد تلقائياً (exponential backoff) لحد 10 ثواني — لتقليل الضغط على السيرفر.
3. اختبار البروكسي له مسار سريع ولا ينتظر انتهاء مهام الاستخراج الطويلة.
4. لما يلاقي مهمة، يفتح Chromium، يسجل دخول بالكوكيز/كلمة المرور المشفّرة، وينفّذ المهمة.
