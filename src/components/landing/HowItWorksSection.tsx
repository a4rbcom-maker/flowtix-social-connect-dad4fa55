        ...
        <div className="relative grid gap-8 md:grid-cols-3">
          ...
          <div className="absolute top-12 left-[16.67%] right-[16.67%] hidden md:block">
            <div
              ...
              style={{
                background: "linear-gradient(90deg, oklch(0.55 0.25 280 / 0.5), oklch(0.6 0.2 240 / 0.3), oklch(0.55 0.25 280 / 0.5))",
          ...
          {t.howItWorks.steps.map((step, i) => (
            ...
            >
              <div className="relative mx-auto mb-6">
                ...
                <div className="relative mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-primary to-primary-glow text-white shadow-xl shadow-primary/25 transition-all duration-300 hover:scale-110 hover:shadow-2xl hover:shadow-primary/40">
                  {stepIcons[i]}
                  {/* Step number badge */}
