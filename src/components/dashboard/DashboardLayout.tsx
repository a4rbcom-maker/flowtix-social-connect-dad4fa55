...
export function DashboardLayout({ children, title }: DashboardLayoutProps) {
  ...
  type LeafItem = { kind: "leaf"; icon: typeof LayoutDashboard; label: string; to: "/dashboard" | "/dashboard/control" | "/dashboard/facebook" | "/dashboard/facebook/groups" | "/dashboard/facebook/insights" | "/dashboard/facebook/messages" | "/dashboard/facebook/messenger-contacts" | "/dashboard/facebook/bot" | "/dashboard/facebook/jobs" | "/dashboard/facebook/history" | "/dashboard/facebook/group-extraction" | "/dashboard/facebook/campaigns" | "/dashboard/facebook/templates" | "/dashboard/facebook/media" | "/dashboard/facebook/autoreply" | "/dashboard/whatsapp" | "/dashboard/whatsapp/inbox" | "/dashboard/whatsapp/accounts" | "/dashboard/whatsapp/bot" | "/dashboard/whatsapp/automation" | "/dashboard/whatsapp/settings" | "/dashboard/whatsapp/contacts" | "/dashboard/bulk" | "/dashboard/enrich" | "/dashboard/customers" | "/dashboard/activity" | "/dashboard/profile" | "/dashboard/notifications"; search?: Record<string, string> };
      ...
      items: [
        {
          ...
          children: [
            ...
            { kind: "leaf", icon: UsersRound, label: lang === "ar" ? "جهات اتصال Messenger" : "Messenger contacts", to: "/dashboard/facebook/messenger-contacts" },
