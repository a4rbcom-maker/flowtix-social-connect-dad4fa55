...
function CampaignsPage() {
  ...
  const statusStyle = (s: string) => {
    switch (s) {
      case "running": return "bg-blue-500/10 text-blue-600 dark:text-blue-300 border-blue-500/30";
      case "completed": return "bg-emerald-500/10 text-emerald-600 dark:text-emerald-300 border-emerald-500/30";
      case "failed": return "bg-destructive/10 text-destructive border-destructive/30";
      case "paused": return "bg-amber-500/10 text-amber-600 dark:text-amber-300 border-amber-500/30";
      case "queued": return "bg-violet-500/10 text-violet-600 dark:text-violet-300 border-violet-500/30";
