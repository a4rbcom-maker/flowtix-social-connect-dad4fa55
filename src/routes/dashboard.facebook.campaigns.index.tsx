...
function CampaignsPage() {
  ...
  const statusStyle = (s: string) => {
    const { tone, border } = statusBadgeTone(s);
    // Legacy call sites expect `border-*` in the string — keep the border for
    // the outlined chip variant while sharing tone tokens.
    return `${tone} ${border}`;
  };
