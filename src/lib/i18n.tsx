...
const translations = {
  ar: {
    ...
    hero: {
      badge: "🔥 بدون موظفين.. بدون مجهود.. مبيعات بتشتغل لوحدها",
      title1: "حوّل جروباتك ومحادثاتك",
      title2: "لمبيعات تشتغل على الأوتوماتيك",
      title3: "24 ساعة.. وانت نايم",
      desc: "ابعت لآلاف العملاء على فيسبوك وواتساب بضغطة واحدة، وخلّي الذكاء الاصطناعي يرد ويقفل البيعة بدالك — في وقت قياسي وبتكلفة أقل ٩٠٪",
  ...
  en: {
    ...
    hero: {
      badge: "🔥 No staff. No effort. Sales on autopilot.",
      title1: "Turn Your Groups & Chats",
      title2: "Into Sales That Sell Themselves",
      title3: "24/7 — Even While You Sleep",
      desc: "Blast thousands of customers on Facebook & WhatsApp in one click, and let AI reply and close deals for you — in record time at 90% lower cost",
      cta: "Start Free Now",
