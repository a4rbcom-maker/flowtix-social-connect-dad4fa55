...
export const igSupabaseService = {
  /** IG jobs are scoped by user_id (workspaces were removed by migration
   *  2026072716 — the old workspace derivation threw for every user).
   *  Kept as a function so callers keep a single resolution point. */
