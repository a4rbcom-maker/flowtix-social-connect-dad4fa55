  ...
  apps: [
    {
      ...
      env: {
        ...
        WA_BRIDGE_API_KEY: process.env.WA_BRIDGE_API_KEY || "",
        WA_BRIDGE_WEBHOOK_SECRET: process.env.WA_BRIDGE_WEBHOOK_SECRET || "",
        WA_PUBLIC_WEBHOOK_URL: process.env.WA_PUBLIC_WEBHOOK_URL || "",
